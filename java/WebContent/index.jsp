...
<style>
		...
		[name=forMenu] {width:26%; height:45%; position: absolute; top:10%; left:0%;
		 background:#778899; border: 2px solid grey;}
		 
		[name=forTable] {width:70%; height:45%; position: absolute; top:10%; left:28%; }
...
<body>
<div id='header'>
  <p>Лабораторна робота №5<br>
	Робота з базою даних Hotel </p>
